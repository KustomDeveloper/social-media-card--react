  ...
  photo: 'https://www.thehumornation.com/wp-content/uploads/2017/05/hairy-man.jpg',
  updates: [
      {
        platform: 'twitter',
...
class Photo extends React.Component {
  render () {
      return(
          <div className="photo">
            <img className="card-image" src={this.props.photo} alt="Photo" />
          </div>
      )
  }  
}
  ...
  render () {
      return(
          <div className="bio">
              ...
              <div className="occupation"><p>{this.props.occupation.title} at {this.props.occupation.employer}</p></div>
          </div>
      )
  }  
}
